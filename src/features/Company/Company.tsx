...
const Company: React.FC = () => {
  return (
    <div className="text-[22px] text-white">
      ...
      <Container>
        <div className="text-[12px] md:text-[22px] font-normal">
          <div className="mt-[65px]">
            ...
            инвестирует в обучение, автоматизацию процессов, исследования и качество услуг. Мы постоянно развиваемся для того,
            чтобы делать клиентов счастливыми, а сотрудников и партнеров — успешными. Кыймылсыз мулк Агенттиги Квадратный Метр
            мулк сферасында сиздин эн чоон жардамчыныз! Биз кыймылсыз-мулк сферасында кучтуу компания курууга кызыктарбыз жаны
            инновация, жоопкерчилик жана жакшы мамиле ар бир кардаарга .Компания окуп онугуусуно салымын дайыма кошуп турат.Биз
            дайыма осуп турабыз,себеби биз учун кардаардын ыраазы болушу ото маанилуу,жана кызматкерлердин ийгилиги биринчи
            оорунда. Kvadrat kg Найди свой уют!
          </div>
          ...
          <div className="mt-6">
            <p>Телефон: +996 (708) 242-906</p>
            <p>Email: kvadrat.kg312@mail.ru</p>
            <p>Адрес: г. Бишкек, Темирязева 97</p>
          </div>

          <div className="mt-7">
            <p>С уважением,</p>
            <p>Команда "Бишкек Недвижимость"</p>
          </div>
