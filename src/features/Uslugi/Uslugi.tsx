...
const servicesDiv =
  "flex flex-col mb-[50px] md:mb-[0px] md:flex-row items-start md:justify-between gap-[65px] md:gap-[15px] md:w-full md:mt-[65px] w-[260px] h-[1060px] md:h-[300px] pt-[30px] overflow-x-auto";
