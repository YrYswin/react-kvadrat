  ...
  return (
    <Container>
      <div className="text-white mt-[30px] md:mt-[136px] flex flex-col  items-center justify-center w-full ">
        <div className="block py-5 text-sm font-semibold uppercase shadow-lg lg:hidden">
        ...
        <div className="flex w-full overflow-x-auto">
          <div className="flex gap-3 lg:grid lg:grid-cols-3 lg:grid-rows-5 lg:gap-5">
            ...
            <div className=" w-full h-full hidden lg:block shadow-lg col-span-2 row-span-1 xl:text-[28px] lg:text-[22px] font-semibold uppercase md:hidden">
              <span className="">3 аргумента почему вам стоит доверить решение вашего квартирного вопроса </span>
              <span className="text-white bg-[#DC2215]"> именно нам </span>
            </div>

            <div style={{ backgroundImage: "url('/img/argument.png')" }} className={`${style3}`}>
              <div className="w-[374px] h-[168px] flex flex-col gap-2 lg:gap-[14px]">
...
const style ="bg-cover bg-center rounded-md shadow-lg col-span-1 row-span-3 md:w-[270px] md:h-[360px] sm:w-[218px] sm:h-[290px] lg:w-[330px] lg:h-[420px]  xl:w-[420px] xl:h-[531px] md:px-2 w-[265px] h-[333px]  lg:px-8 px-4 flex md:items-end py-6 ";
const style2 ="bg-cover bg-center rounded-md shadow-lg col-span-1 row-span-3 md:w-[270px] md:h-[360px] sm:w-[218px] sm:h-[290px] lg:w-[330px] lg:h-[420px]  xl:w-[420px] xl:h-[531px] md:px-2 w-[265px] h-[333px] lg:py-28 lg:px-8 px-4 flex md:items-end py-6 md:py-20";
const style3 ="bg-cover bg-center rounded-md shadow-lg col-span-1 row-span-3 md:w-[270px] md:h-[360px] sm:w-[218px] sm:h-[290px] lg:w-[330px] lg:h-[420px]  xl:w-[420px] xl:h-[531px] md:px-2 w-[265px] h-[333px] lg:py-24 lg:px-8 px-4 flex md:items-end py-6 md:py-30";
